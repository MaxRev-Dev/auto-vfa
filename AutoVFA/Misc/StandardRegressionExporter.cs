...
{
    internal class StandardRegressionExporter : IExportContextBuilder
    {
        private string[] _availableAcids;
        private IList<RegressionResult> _results;
        private IList<VFADataItem> _standards;
        private string _baseNormAcid;
        ...
        public IExportContextBuilder SetAvialableAcids(IEnumerable<string> names)
        {
